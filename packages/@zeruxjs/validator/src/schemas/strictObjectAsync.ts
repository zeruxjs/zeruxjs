import { getDefault, getFallback } from '../methods/index.js';
import type {
  BaseSchemaAsync,
  ErrorMessage,
  InferObjectInput,
...
import { _addIssue, _getStandardProps } from '../utils/index.js';
import type { strictObject } from './strictObject.js';
import type { StrictObjectIssue } from './types/strictObject.js';
